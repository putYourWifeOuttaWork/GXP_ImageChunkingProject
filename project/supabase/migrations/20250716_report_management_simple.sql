-- Report Management System - Simple Version
-- This version creates one table at a time with immediate RLS

-- STEP 1: Create report_folders table
...
GRANT ALL ON public.report_folders TO authenticated;

-- Enable RLS without policies first
...
CREATE POLICY "temp_allow_all_folders"
...
-- Enable RLS on all tables with temporary allow-all policies
...
CREATE POLICY "temp_allow_all_permissions"
ON public.report_folder_permissions
FOR ALL
TO authenticated
USING (true)
WITH CHECK (true);

CREATE POLICY "temp_allow_all_reports"
...
CREATE POLICY "temp_allow_all_snapshots"
...
CREATE POLICY "temp_allow_all_versions"
ON public.report_version_history
FOR ALL
TO authenticated
USING (true)
WITH CHECK (true);

CREATE POLICY "temp_allow_all_logs"
