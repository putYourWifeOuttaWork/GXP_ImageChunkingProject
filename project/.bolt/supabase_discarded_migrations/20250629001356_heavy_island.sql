...
-- Create the updated function with support for split image templates and correct enum casting
...
BEGIN
  ...
  INSERT INTO submissions (
    ...
    temperature,
    humidity,
    airflow, -- Corrected: Cast to airflow_enum
    odor_distance, -- Corrected: Cast to odor_distance_enum
    weather, -- Corrected: Cast to weather_enum
    notes,
    created_by,
    indoor_temperature,
    indoor_humidity,
  ...
  VALUES (
    ...
    (p_submission_data->>'airflow')::airflow_enum, -- Corrected casting
    (p_submission_data->>'odor_distance')::odor_distance_enum, -- Corrected casting
    (p_submission_data->>'weather')::weather_enum, -- Corrected casting
...
COMMENT ON FUNCTION public.create_submission_session IS 'Creates a submission and session with optional petri and gasifier observations from templates. Supports split image petri templates. Corrected enum casting.';