/*
  # Fix enum casting and function ambiguity issues in create_submission_session

  1. Changes
    - Drop ALL versions of the function regardless of parameter signatures
    - Implement proper null/empty string handling for enum fields
    - Use variable declarations to safely cast enum values
    - Add better error handling and validation
    
  2. Purpose
    - Resolve "method argument is missing" error
    - Prevent PostgreSQL enum casting failures with empty strings or nulls
    - Ensure consistent function behavior
*/
...
-- Create a completely new version of the function with robust enum handling
...
COMMENT ON FUNCTION public.create_submission_session IS 'Creates a submission and session with optional petri and gasifier observations from templates. Handles null and empty string values for enum fields to prevent casting errors.';