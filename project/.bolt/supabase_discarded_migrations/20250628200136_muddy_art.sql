/*
  # Update Site Template Functions for Image Splitting Support
  
  1. Updates
    - Modify the update_site_template_defaults RPC function to handle split image templates
    - Enhance validation for petri_defaults to include split image properties
    
  2. Purpose
    - Enable consistent storage and management of split image configuration in site templates
    - Validate split image configuration data
*/
