...
-- Create the function again with parameters in strict alphabetical order
...
COMMENT ON FUNCTION public.create_submission_session IS 'Creates a submission and session with optional petri and gasifier observations from templates. Parameters are in strict alphabetical order to ensure compatibility with Supabase RPC calls.';